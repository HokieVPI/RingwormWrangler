 ...
 * 
 * Configuration:
 * - Anchor Position: (0, 0) meters (can be modified)
...
const int32_t ANCHOR_X = 0;    // X position in meters (can be negative)
const int32_t ANCHOR_Y = 0;    // Y position in meters (can be negative)

...
data7_j= importdata("test_3_27_1");
data7_j = data7_j.data;
goalx = [];
goaly = [];
heading = [];
azimuth = [];
...
% starboardmotor = [];
i = 1;
while i <= height(data7_j)-6
    goalx = [goalx; data7_j(i,1)];
    goaly = [goaly; data7_j(i+1,1)];
    heading = [heading; data7_j(i+2,1)];
    azimuth = [azimuth; data7_j(i+3,1)];
    robotx = [robotx; data7_j(i+4,1)];
    roboty = [roboty; data7_j(i+5,1)];
    % portmotor = [portmotor; data6_j(i+6,1)];
    % starboardmotor = [starboardmotor; data6_j(i+7,1)];
    i = i+6;
end
